...
export const SpotifyIcon = () => {
  return (
    <svg
      className="fill-current text-green-500 hover:text-green-400 w-7"
...
export const InfoIcon = ({ title }: { title: string }) => {
  return createElement(InformationCircleIcon, {
    className:
      "w-7 text-blue-400 hover:text-blue-500 cursor-pointer select-none",
    title: title,
  });
};

export const MusicNoteIcon = () => {
  return createElement(MusicalNoteIcon, {
